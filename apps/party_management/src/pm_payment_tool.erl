...
-import(pm_condition, [some_defined/1, ternary_and/1, ternary_with_defined/1]).
...
test_payment_system_condition(
    ...
    ternary_and([
        ...
        TmIs == undefined orelse ternary_with_defined([Tm, TmIs == Tm])
    ]).

test_issuer_country_condition(Country, #domain_BankCard{issuer_country = TargetCountry}, _Rev) ->
    ternary_with_defined([TargetCountry, Country == TargetCountry]).
...
%% TODO: Should `crypto_currency_is` be reverse compatible?
